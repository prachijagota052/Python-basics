# KBC
ques=["""1. ________ day is observed as World Standards Day.
 (A) Nov 15
 (B) Oct 14
 (C) Dec 2
 (D) June 26""",
...
for index,i in enumerate(ques):
        ...
        if(n!=ans[index]):
            print("wrong answer. your total cash prize is",cash[index])
            break
        else:
            print("you won",cash[index+1])
            if(index<len(ques)-1):
                    print("NEXT QUESTION:")
